...
import co.thorugoh.netflixremake.util.DownloadImageTask
import co.thorugoh.netflixremake.util.MovieTask
...
class MovieActivity : AppCompatActivity(), MovieTask.Callback{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtTitle = findViewById(R.id.movie_txt_cast)
        ...
        val url = "https://api.tiagoaguiar.co/netflixapp/movie/$id?apiKey=8f357272-8662-4ee3-aeb4-b409e835cfa3"
